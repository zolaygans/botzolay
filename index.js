...
const instagram = 'https://instagram.com/zolay31'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @zolay_31`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @zolay_31`)
})
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾ZOLAYBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/zolay_31' ,MessageType.text);
}
else if (text == '#menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾ZOLAYBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/zolay_31' ,MessageType.text);
}
